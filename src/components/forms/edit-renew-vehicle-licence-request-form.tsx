...
import {
  fetchVehicleDetails,
  updateVehicleLicenseRenewalRequest,
...
const FormSection = ({
  ...
  useEffect(() => {
    ...
    handleFormSectionChange(sectionIndex, {
      regNumber: registrationNumberToFetch || vehicleDetails?.regNumber,
    });
  }, [vehicleDetails]);
  ...
  useEffect(() => {
    ...
    setSelectedYearOfManufacture(dateObject);
    setVehicleDetails(defaultVehicleValues);
  }, []);
      ...
      <div className="grid grid-cols-1 gap-y-2 gap-x-2 sm:grid-cols-12">
        ...
        <InputWrapper outerClassName="sm:col-span-3">
          ...
          <AntInput
            ...
            defaultValue={
              defaultVehicleValues?.chassisNumber ||
        ...
        <InputWrapper outerClassName="sm:col-span-3">
          ...
          <AntInput
            ...
            defaultValue={
              defaultVehicleValues?.previousRegNumber ||
              vehicleDetails?.previousRegNumber
            }
            type="text"
          />
        </InputWrapper>
        <InputWrapper outerClassName="sm:col-span-3">
          ...
          <AntInput
            ...
            defaultValue={
              defaultVehicleValues?.engineNumber || vehicleDetails?.engineNumber
            }
            type="text"
          />
        </InputWrapper>
...
const Index: React.FC<{vlr: IVehicleLicenceRequest}> = ({vlr}) => {
  ...
  const onSubmit = async (data: FormProps) => {
    ...
    try {
      setLoading(true);
      const {data} = await updateVehicleLicenseRenewalRequest(
        payload,
        vlr.vlRequestSlug
      );

      toast.success("Vehicle License Renewal Request updated successfully");
      setLoading(false);
