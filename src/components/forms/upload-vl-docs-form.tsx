...
import {vLDocsToUpload} from "components/vehicle-license/constants";
    ...
    <>
      <div className="flex flex-col justify-around items-center">
        <InputWrapper outerClassName="">
          ...
          <Select
            defaultValue={vLDocsToUpload[0]}
            loading={false}
            onChange={handleDocumentChange}
            style={{width: "340px"}}>
            {vLDocsToUpload.map((option) => (
        ...
        <button
          ...
          type="button"
          className={`inline-flex justify-center px-3 py-2 my-2 text-sm font-medium text-white bg-green-500 border border-transparent shadow-sm rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 ${
