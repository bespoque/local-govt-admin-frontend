...
import {UpdateStockInForm} from "components/stock-in/stock-in-update-form";
...
const Index: React.FC = () => {
  ...
  const [stockIn, setStockIn] = useState<IStockIn>(null);
  const userData = useAppSelector((state) => state.auth);
  const router = useRouter();
  const StockInOrderId = router?.query?.stockInOrderId;
