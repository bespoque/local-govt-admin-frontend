...
import CreateTransferRequestForm from "components/forms/create-transfer-request-form";
...
const Index: React.FC = () => {
  ...
  return (
    <React.Fragment>
      <SectionTitle
        title="Manage Outgoing Transfer Requests"
        subtitle="Outgoing Transfer Requests"
      />
      ...
      <div>
        <Modal
          ...
          <div>
            <CreateTransferRequestForm closeModal={closeModal} />
          </div>
        </Modal>
      </div>
      {isLoading ? (
              ...
              <tbody>
                {data &&
                  data.map((sor, i) => (
                    <Link
                      legacyBehavior
                      href={`/inventory/transfer/request/outgoing/${sor.stockOutRequestOrderId}`}>
                      <tr
                        key={sor.id}
